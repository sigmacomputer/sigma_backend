"""
Django settings for sigmabackend project.
...
SECRET_KEY = "django-insecure-aqic@h=^ycrb+hw0oo+)5s&z*df=wes-$v^b5hz32f073r@4%_"
...
ROOT_URLCONF = "sigmabackend.urls"
...
WSGI_APPLICATION = "sigmabackend.wsgi.application"
